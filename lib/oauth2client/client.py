...
import lib.oauth2client
from lib.oauth2client import _helpers
from lib.oauth2client import _pkce
from lib.oauth2client import clientsecrets
from lib.oauth2client import transport


HAS_OPENSSL = False
HAS_CRYPTO = False
try:
    from lib.oauth2client import crypt
    HAS_CRYPTO = True
...
class GoogleCredentials(OAuth2Credentials):
    ...
    def __init__(self, access_token, client_id, client_secret, refresh_token,
                 ...
                 revoke_uri=lib.oauth2client.GOOGLE_REVOKE_URI):
...
def _get_application_default_credential_from_file(filename):
    ...
    if client_credentials['type'] == AUTHORIZED_USER:
        return GoogleCredentials(
            ...
            token_expiry=None,
            token_uri=lib.oauth2client.GOOGLE_TOKEN_URI,
...
def credentials_from_code(client_id, client_secret, scope, code,
                          ...
                          user_agent=None,
                          token_uri=lib.oauth2client.GOOGLE_TOKEN_URI,
                          auth_uri=lib.oauth2client.GOOGLE_AUTH_URI,
                          revoke_uri=lib.oauth2client.GOOGLE_REVOKE_URI,
                          device_uri=lib.oauth2client.GOOGLE_DEVICE_URI,
                          token_info_uri=lib.oauth2client.GOOGLE_TOKEN_INFO_URI,
                          pkce=False,
                          code_verifier=None):
