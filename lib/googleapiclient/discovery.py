...
from lib.googleapiclient.http import HttpMock
...
from lib.oauth2client.client import GoogleCredentials

# Oauth2client < 3 has the positional helper in 'util', >= 3 has it
# in '_helpers'.
try:
  from lib.oauth2client.util import _add_query_parameter
  from lib.oauth2client.util import positional
except ImportError:
  from lib.oauth2client._helpers import _add_query_parameter
  from lib.oauth2client._helpers import positional
