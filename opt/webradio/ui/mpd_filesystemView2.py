...
from PyQt4.QtGui import QFileSystemModel, QTreeView, QApplication, QIcon, QAbstractItemView, QMainWindow, \
    QItemSelectionModel, QStyledItemDelegate, QSortFilterProxyModel
